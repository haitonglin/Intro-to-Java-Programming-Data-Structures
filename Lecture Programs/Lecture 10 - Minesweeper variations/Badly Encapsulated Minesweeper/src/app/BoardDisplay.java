...
public class BoardDisplay {
	...
	public void showBoard(int xCursor, int yCursor, boolean[][] revealed, boolean showMines) {
		...
		// 			System.out.print("*");	
		// 		} else {
		// 			int adjacentMineCount = this.board.getAdjacentMineCount(x, y);
